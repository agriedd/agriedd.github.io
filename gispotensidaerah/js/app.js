...
var app = new Vue({
  ...
  methods: {
    openSearch: function openSearch() {
      this.global.search.show = true;
    },
    closeSearch: function closeSearch() {
      this.global.search.show = false;
    },
    showMobileMenu: function showMobileMenu() {
      this.global.navbar.show = true;
    },
    hideMobileMenu: function hideMobileMenu() {
      this.global.navbar.show = false;
    },
    toggleMobileMenu: function toggleMobileMenu() {
      this.global.navbar.show = !this.global.navbar.show;
    }
  },
  watch: {
    'global.search.show': function globalSearchShow(val, old) {
      if (val) {
